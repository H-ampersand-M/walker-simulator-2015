...
PROGRAM_NAME = walker-simulator-2015
...
vpath %.h $(PATH_INCLUDE) $(PATH_INCLUDE)/walker
vpath %.h build/autogen/$(PATH_INCLUDE) build/autogen/$(PATH_INCLUDE)/walker

vpath %.c $(PATH_SRC) $(PATH_SRC)/walker
vpath %.o $(PATH_OBJ)
vpath %.a $(PATH_LIB)
vpath %.so $(PATH_LIB)
...
#     $ make CC=clang
#     $ make CFLAGS="-O2"
#     $ make install PREFIX=/opt/walker-simulator-2015
